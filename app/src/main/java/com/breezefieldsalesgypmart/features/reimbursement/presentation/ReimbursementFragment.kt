package com.breezefieldsalesgypmart.features.reimbursement.presentation
...
import com.breezefieldsalesgypmart.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalesgypmart.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalesgypmart.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalesgypmart.app.utils.CustomTextWatcher
import com.breezefieldsalesgypmart.app.utils.PermissionUtils
import com.breezefieldsalesgypmart.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalesgypmart.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalesgypmart.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalesgypmart.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalesgypmart.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalesgypmart.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalesgypmart.features.reimbursement.model.*
import com.breezefieldsalesgypmart.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalesgypmart.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalesgypmart.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalesgypmart.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalesgypmart.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalesgypmartData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalesgypmartData() {
