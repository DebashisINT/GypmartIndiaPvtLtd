package com.breezefieldsalesgypmart.features.dashboard.presentation
...
import com.breezefieldsalesgypmart.*
import com.breezefieldsalesgypmart.R
import com.breezefieldsalesgypmart.app.*
import com.breezefieldsalesgypmart.app.NewFileUtils.browseDocuments
import com.breezefieldsalesgypmart.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesgypmart.app.NewFileUtils.getExtension
import com.breezefieldsalesgypmart.app.domain.*
import com.breezefieldsalesgypmart.app.types.DashboardType
import com.breezefieldsalesgypmart.app.types.FragType
import com.breezefieldsalesgypmart.app.types.TopBarConfig
import com.breezefieldsalesgypmart.app.uiaction.DisplayAlert
import com.breezefieldsalesgypmart.app.utils.*
import com.breezefieldsalesgypmart.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesgypmart.base.BaseResponse
import com.breezefieldsalesgypmart.base.presentation.BaseActivity
import com.breezefieldsalesgypmart.base.presentation.BaseFragment
import com.breezefieldsalesgypmart.features.NewQuotation.*
import com.breezefieldsalesgypmart.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesgypmart.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesgypmart.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesgypmart.features.SearchLocation.locationInfoModel
import com.breezefieldsalesgypmart.features.TA.ViewAllTAListFragment
import com.breezefieldsalesgypmart.features.achievement.AchievementFragment
import com.breezefieldsalesgypmart.features.activities.presentation.*
import com.breezefieldsalesgypmart.features.addAttendence.*
import com.breezefieldsalesgypmart.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesgypmart.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesgypmart.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesgypmart.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesgypmart.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesgypmart.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesgypmart.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesgypmart.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesgypmart.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesgypmart.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesgypmart.features.alarm.model.AlarmData
import com.breezefieldsalesgypmart.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesgypmart.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesgypmart.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesgypmart.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesgypmart.features.attendance.AttendanceFragment
import com.breezefieldsalesgypmart.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesgypmart.features.attendance.model.AttendanceRequest
import com.breezefieldsalesgypmart.features.attendance.model.AttendanceResponse
import com.breezefieldsalesgypmart.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesgypmart.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesgypmart.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesgypmart.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesgypmart.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesgypmart.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesgypmart.features.billing.presentation.BillingListFragment
import com.breezefieldsalesgypmart.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesgypmart.features.chat.model.ChatListDataModel
import com.breezefieldsalesgypmart.features.chat.model.ChatUserDataModel
import com.breezefieldsalesgypmart.features.chat.model.GroupUserDataModel
import com.breezefieldsalesgypmart.features.chat.presentation.*
import com.breezefieldsalesgypmart.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesgypmart.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesgypmart.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesgypmart.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesgypmart.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesgypmart.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesgypmart.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesgypmart.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesgypmart.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesgypmart.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesgypmart.features.contacts.ContactDtls
import com.breezefieldsalesgypmart.features.contacts.ContactGr
import com.breezefieldsalesgypmart.features.contacts.ContactsAddFrag
import com.breezefieldsalesgypmart.features.contacts.ContactsFrag
import com.breezefieldsalesgypmart.features.contacts.SchedulerViewFrag
import com.breezefieldsalesgypmart.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesgypmart.features.contacts.TemplateAddFrag
import com.breezefieldsalesgypmart.features.contacts.TemplateViewFrag
import com.breezefieldsalesgypmart.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesgypmart.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesgypmart.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesgypmart.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesgypmart.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesgypmart.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesgypmart.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesgypmart.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesgypmart.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesgypmart.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesgypmart.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesgypmart.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesgypmart.features.document.presentation.DocumentListFragment
import com.breezefieldsalesgypmart.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesgypmart.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesgypmart.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesgypmart.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesgypmart.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesgypmart.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesgypmart.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesgypmart.features.home.presentation.HomeFragment
import com.breezefieldsalesgypmart.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesgypmart.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesgypmart.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesgypmart.features.lead.LeadFrag
import com.breezefieldsalesgypmart.features.lead.ViewLeadFrag
import com.breezefieldsalesgypmart.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesgypmart.features.leaveapplynew.LeaveHome
import com.breezefieldsalesgypmart.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesgypmart.features.localshops.LocalShopListFragment
import com.breezefieldsalesgypmart.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesgypmart.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesgypmart.features.location.*
import com.breezefieldsalesgypmart.features.location.api.LocationRepoProvider
import com.breezefieldsalesgypmart.features.location.model.*
import com.breezefieldsalesgypmart.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesgypmart.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesgypmart.features.login.ShopFeedbackEntity
import com.breezefieldsalesgypmart.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesgypmart.features.login.presentation.LoginActivity
import com.breezefieldsalesgypmart.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesgypmart.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesgypmart.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesgypmart.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesgypmart.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesgypmart.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesgypmart.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesgypmart.features.member.MapViewForTeamFrag
import com.breezefieldsalesgypmart.features.member.model.TeamLocDataModel
import com.breezefieldsalesgypmart.features.member.model.TeamShopListDataModel
import com.breezefieldsalesgypmart.features.member.presentation.*
import com.breezefieldsalesgypmart.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesgypmart.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesgypmart.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesgypmart.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesgypmart.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesgypmart.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesgypmart.features.myjobs.presentation.*
import com.breezefieldsalesgypmart.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesgypmart.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesgypmart.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesgypmart.features.nearbyshops.model.ShopData
import com.breezefieldsalesgypmart.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesgypmart.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesgypmart.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesgypmart.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesgypmart.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesgypmart.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesgypmart.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesgypmart.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesgypmart.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesgypmart.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesgypmart.features.newcollectionreport.*
import com.breezefieldsalesgypmart.features.notification.NotificationFragment
import com.breezefieldsalesgypmart.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesgypmart.features.orderList.NewOrderListFragment
import com.breezefieldsalesgypmart.features.orderList.OrderListFragment
import com.breezefieldsalesgypmart.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesgypmart.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesgypmart.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesgypmart.features.orderhistory.TimeLineFragment
import com.breezefieldsalesgypmart.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesgypmart.features.orderhistory.model.FetchLocationRequest
import com.breezefieldsalesgypmart.features.orderhistory.model.FetchLocationResponse
import com.breezefieldsalesgypmart.features.orderhistory.model.LocationData
import com.breezefieldsalesgypmart.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesgypmart.features.performance.GpsStatusFragment
import com.breezefieldsalesgypmart.features.performance.PerformanceFragment
import com.breezefieldsalesgypmart.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesgypmart.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesgypmart.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesgypmart.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesgypmart.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesgypmart.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesgypmart.features.photoReg.*
import com.breezefieldsalesgypmart.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesgypmart.features.quotation.presentation.*
import com.breezefieldsalesgypmart.features.reimbursement.presentation.*
import com.breezefieldsalesgypmart.features.report.presentation.*
import com.breezefieldsalesgypmart.features.returnsOrder.*
import com.breezefieldsalesgypmart.features.settings.presentation.SettingsFragment
import com.breezefieldsalesgypmart.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesgypmart.features.shopdetail.presentation.*
import com.breezefieldsalesgypmart.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesgypmart.features.stock.StockDetailsFragment
import com.breezefieldsalesgypmart.features.stock.StockListFragment
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesgypmart.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesgypmart.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesgypmart.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesgypmart.features.survey.SurveyFrag
import com.breezefieldsalesgypmart.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesgypmart.features.survey.SurveyViewFrag
import com.breezefieldsalesgypmart.features.task.presentation.AddTaskFragment
import com.breezefieldsalesgypmart.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesgypmart.features.task.presentation.EditTaskFragment
import com.breezefieldsalesgypmart.features.task.presentation.TaskListFragment
import com.breezefieldsalesgypmart.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesgypmart.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesgypmart.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesgypmart.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesgypmart.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.CartFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesgypmart.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesgypmart.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesgypmart.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesgypmart.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesgypmart.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesgypmart.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesgypmart.features.weather.presentation.WeatherFragment
import com.breezefieldsalesgypmart.mappackage.MapActivity
import com.breezefieldsalesgypmart.mappackage.MapActivityWithoutPath
import com.breezefieldsalesgypmart.mappackage.SendBrod
import com.breezefieldsalesgypmart.widgets.AppCustomEditText
import com.breezefieldsalesgypmart.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesgypmartlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldsalesgypmart/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
