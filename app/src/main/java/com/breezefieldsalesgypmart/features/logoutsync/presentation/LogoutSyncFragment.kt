package com.breezefieldsalesgypmart.features.logoutsync.presentation
...
import com.breezefieldsalesgypmart.app.AppDatabase
...
import com.breezefieldsalesgypmart.app.utils.AppUtils
...
import com.breezefieldsalesgypmart.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesgypmart.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesgypmart.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesgypmart.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesgypmart.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesgypmart.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesgypmart.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalesgypmart.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesgypmart.features.orderhistory.model.*
...
import com.breezefieldsalesgypmart.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesgypmart.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesgypmart.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesgypmart.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldsalesgypmart.features.stock.api.StockRepositoryProvider
import com.breezefieldsalesgypmart.features.stock.model.AddStockInputParamsModel
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesgypmart.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesgypmart.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldsalesgypmart.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesgypmart.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesgypmart.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesgypmart.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesgypmart.mappackage.SendBrod
import com.breezefieldsalesgypmart.widgets.AppCustomTextView
import com.breezefieldsalesgypmart.MonitorService
import com.breezefieldsalesgypmart.MySingleton
...
import com.breezefieldsalesgypmart.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesgypmart.features.login.model.GetConcurrentUserResponse
import com.breezefieldsalesgypmart.features.login.model.WhatsappApiData
import com.breezefieldsalesgypmart.features.performance.model.Gps_status_list
import com.breezefieldsalesgypmart.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesgypmart.features.returnsOrder.ReturnProductList
import com.breezefieldsalesgypmart.features.returnsOrder.ReturnRequest
import com.breezefieldsalesgypmart.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesgypmartlogsample/log.zip").path);
