...
import com.gypmartfsm.*
import com.gypmartfsm.R
import com.gypmartfsm.app.*
import com.gypmartfsm.app.NewFileUtils.browseDocuments
import com.gypmartfsm.app.NewFileUtils.browsePDFDocuments
import com.gypmartfsm.app.NewFileUtils.getExtension
import com.gypmartfsm.app.domain.*
import com.gypmartfsm.app.types.DashboardType
import com.gypmartfsm.app.types.FragType
import com.gypmartfsm.app.types.TopBarConfig
import com.gypmartfsm.app.uiaction.DisplayAlert
import com.gypmartfsm.app.utils.*
import com.gypmartfsm.app.utils.AppUtils.Companion.isProfile
import com.gypmartfsm.base.BaseResponse
import com.gypmartfsm.base.presentation.BaseActivity
import com.gypmartfsm.base.presentation.BaseFragment
import com.gypmartfsm.features.NewQuotation.*
import com.gypmartfsm.features.NewQuotation.api.GetQuotRegProvider
import com.gypmartfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.gypmartfsm.features.SearchLocation.SearchLocationFragment
import com.gypmartfsm.features.SearchLocation.locationInfoModel
import com.gypmartfsm.features.TA.ViewAllTAListFragment
import com.gypmartfsm.features.achievement.AchievementFragment
import com.gypmartfsm.features.activities.presentation.*
import com.gypmartfsm.features.addAttendence.*
import com.gypmartfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.gypmartfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.gypmartfsm.features.addAttendence.model.GetReportToFCMResponse
import com.gypmartfsm.features.addAttendence.model.GetReportToResponse
import com.gypmartfsm.features.addAttendence.model.Leave_list_Response
import com.gypmartfsm.features.addorder.presentation.AddOrderFragment
...
import com.gypmartfsm.features.addshop.presentation.AddShopFragment
import com.gypmartfsm.features.addshop.presentation.OTPVerificationDialog
import com.gypmartfsm.features.addshop.presentation.ScanImageFragment
import com.gypmartfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.gypmartfsm.features.alarm.model.AlarmData
import com.gypmartfsm.features.alarm.presetation.AttendanceReportFragment
import com.gypmartfsm.features.alarm.presetation.PerformanceReportFragment
import com.gypmartfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.gypmartfsm.features.alarm.presetation.VisitReportFragment
import com.gypmartfsm.features.attendance.AttendanceFragment
import com.gypmartfsm.features.attendance.api.AttendanceRepositoryProvider
import com.gypmartfsm.features.attendance.model.AttendanceRequest
import com.gypmartfsm.features.attendance.model.AttendanceResponse
import com.gypmartfsm.features.averageshop.presentation.AverageShopFragment
import com.gypmartfsm.features.avgorder.presentation.AverageOrderFragment
import com.gypmartfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.gypmartfsm.features.beatCustom.TeamBeatListFragment
import com.gypmartfsm.features.billing.presentation.AddBillingFragment
import com.gypmartfsm.features.billing.presentation.BillingDetailsFragment
import com.gypmartfsm.features.billing.presentation.BillingListFragment
import com.gypmartfsm.features.changepassword.presentation.ChangePasswordDialog
import com.gypmartfsm.features.chat.model.ChatListDataModel
import com.gypmartfsm.features.chat.model.ChatUserDataModel
import com.gypmartfsm.features.chat.model.GroupUserDataModel
import com.gypmartfsm.features.chat.presentation.*
import com.gypmartfsm.features.chatbot.presentation.ChatBotFragment
import com.gypmartfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.gypmartfsm.features.chatbot.presentation.ReportsFragment
import com.gypmartfsm.features.chatbot.presentation.SelectLanguageDialog
import com.gypmartfsm.features.commondialog.presentation.CommonDialog
import com.gypmartfsm.features.commondialog.presentation.CommonDialogClickListener
import com.gypmartfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.gypmartfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.gypmartfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.gypmartfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.gypmartfsm.features.contacts.ContactDtls
import com.gypmartfsm.features.contacts.ContactGr
import com.gypmartfsm.features.contacts.ContactsAddFrag
import com.gypmartfsm.features.contacts.ContactsFrag
import com.gypmartfsm.features.contacts.SchedulerViewFrag
import com.gypmartfsm.features.contacts.SchedulerAddFormFrag
import com.gypmartfsm.features.contacts.TemplateAddFrag
import com.gypmartfsm.features.contacts.TemplateViewFrag
import com.gypmartfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.gypmartfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.gypmartfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.gypmartfsm.features.damageProduct.ShopDamageProductListFrag
import com.gypmartfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.gypmartfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.gypmartfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.gypmartfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.gypmartfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.gypmartfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.gypmartfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.gypmartfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.gypmartfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.gypmartfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.gypmartfsm.features.device_info.presentation.DeviceInfoListFragment
import com.gypmartfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.gypmartfsm.features.document.DocumentRepoFeatureNewFragment
import com.gypmartfsm.features.document.presentation.DocumentListFragment
import com.gypmartfsm.features.document.presentation.DocumentTypeListFragment
import com.gypmartfsm.features.document.presentation.OpenFileWebViewFragment
import com.gypmartfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.gypmartfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.gypmartfsm.features.dymanicSection.presentation.DynamicListFragment
import com.gypmartfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.gypmartfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.gypmartfsm.features.home.presentation.HomeFragment
import com.gypmartfsm.features.homelocation.presentation.HomeLocationFragment
import com.gypmartfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.gypmartfsm.features.know_your_state.KnowYourStateFragment
import com.gypmartfsm.features.lead.LeadFrag
import com.gypmartfsm.features.lead.ViewLeadFrag
import com.gypmartfsm.features.leaveapplynew.LeaveHome
import com.gypmartfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.gypmartfsm.features.localshops.LocalShopListFragment
import com.gypmartfsm.features.localshops.LocalShopListMapFragment
import com.gypmartfsm.features.localshops.NearByShopsMapFragment
import com.gypmartfsm.features.location.*
import com.gypmartfsm.features.location.api.LocationRepoProvider
import com.gypmartfsm.features.location.model.*
import com.gypmartfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.gypmartfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.gypmartfsm.features.login.ShopFeedbackEntity
import com.gypmartfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.gypmartfsm.features.login.presentation.LoginActivity
import com.gypmartfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.gypmartfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.gypmartfsm.features.marketAssist.MarketAssistTabFrag
import com.gypmartfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.gypmartfsm.features.marketAssist.ShopListMarketAssistFrag
import com.gypmartfsm.features.marketing.presentation.MarketingPagerFragment
import com.gypmartfsm.features.meetinglist.prsentation.MeetingListFragment
import com.gypmartfsm.features.member.MapViewForTeamFrag
import com.gypmartfsm.features.member.model.TeamLocDataModel
import com.gypmartfsm.features.member.model.TeamShopListDataModel
import com.gypmartfsm.features.member.presentation.*
import com.gypmartfsm.features.menuBeat.MenuBeatFrag
import com.gypmartfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.gypmartfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.gypmartfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.gypmartfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.gypmartfsm.features.myjobs.model.CustomerDataModel
import com.gypmartfsm.features.myjobs.presentation.*
import com.gypmartfsm.features.myorder.presentation.MyOrderListFragment
import com.gypmartfsm.features.myprofile.presentation.MyProfileFragment
import com.gypmartfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.gypmartfsm.features.nearbyshops.model.ShopData
import com.gypmartfsm.features.nearbyshops.model.ShopListResponse
import com.gypmartfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.gypmartfsm.features.nearbyshops.presentation.BeatListFragment
import com.gypmartfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.gypmartfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.gypmartfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.gypmartfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.gypmartfsm.features.newcollection.CollectionDetailsStatusFragment
import com.gypmartfsm.features.newcollection.CollectionShopListFragment
import com.gypmartfsm.features.newcollection.NewCollectionListFragment
import com.gypmartfsm.features.newcollectionreport.*
import com.gypmartfsm.features.notification.NotificationFragment
import com.gypmartfsm.features.orderList.NewDateWiseOrderListFragment
import com.gypmartfsm.features.orderList.NewOrderListFragment
import com.gypmartfsm.features.orderList.OrderListFragment
import com.gypmartfsm.features.orderdetail.presentation.OrderDetailFragment
import com.gypmartfsm.features.orderhistory.ActivityMapFragment
import com.gypmartfsm.features.orderhistory.OrderhistoryFragment
import com.gypmartfsm.features.orderhistory.TimeLineFragment
import com.gypmartfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.gypmartfsm.features.orderhistory.model.FetchLocationRequest
import com.gypmartfsm.features.orderhistory.model.FetchLocationResponse
import com.gypmartfsm.features.orderhistory.model.LocationData
import com.gypmartfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.gypmartfsm.features.performance.GpsStatusFragment
import com.gypmartfsm.features.performance.PerformanceFragment
import com.gypmartfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.gypmartfsm.features.performance.model.UpdateGpsInputParamsModel
import com.gypmartfsm.features.performanceAPP.OwnPerformanceFragment
import com.gypmartfsm.features.performanceAPP.PerformanceAppFragment
import com.gypmartfsm.features.performanceAPP.allPerformanceFrag
import com.gypmartfsm.features.permissionList.ViewPermissionFragment
import com.gypmartfsm.features.photoReg.*
import com.gypmartfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.gypmartfsm.features.quotation.presentation.*
import com.gypmartfsm.features.reimbursement.presentation.*
import com.gypmartfsm.features.report.presentation.*
import com.gypmartfsm.features.returnsOrder.*
import com.gypmartfsm.features.settings.presentation.SettingsFragment
import com.gypmartfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.gypmartfsm.features.shopdetail.presentation.*
import com.gypmartfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.gypmartfsm.features.stock.StockDetailsFragment
import com.gypmartfsm.features.stock.StockListFragment
import com.gypmartfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.gypmartfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.gypmartfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.gypmartfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.gypmartfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.gypmartfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.gypmartfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.gypmartfsm.features.survey.SurveyFrag
import com.gypmartfsm.features.survey.SurveyViewDtlsFrag
import com.gypmartfsm.features.survey.SurveyViewFrag
import com.gypmartfsm.features.task.presentation.AddTaskFragment
import com.gypmartfsm.features.task.presentation.CalenderTaskFragment
import com.gypmartfsm.features.task.presentation.EditTaskFragment
import com.gypmartfsm.features.task.presentation.TaskListFragment
import com.gypmartfsm.features.taskManagement.TaskManagementFrag
import com.gypmartfsm.features.taskManagement.ViewTaskManagementFrag
import com.gypmartfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.gypmartfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.gypmartfsm.features.timesheet.presentation.TimeSheetListFragment
import com.gypmartfsm.features.viewAllOrder.CartFragment
import com.gypmartfsm.features.viewAllOrder.OrderTypeListFragment
import com.gypmartfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.gypmartfsm.features.viewAllOrder.ViewCartFragment
import com.gypmartfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.gypmartfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.gypmartfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.gypmartfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.gypmartfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.gypmartfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.gypmartfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.gypmartfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.gypmartfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.gypmartfsm.features.viewPPDDStock.ViewStockFragment
import com.gypmartfsm.features.weather.presentation.WeatherFragment
import com.gypmartfsm.mappackage.MapActivity
import com.gypmartfsm.mappackage.MapActivityWithoutPath
import com.gypmartfsm.mappackage.SendBrod
import com.gypmartfsm.widgets.AppCustomEditText
import com.gypmartfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xgypmartfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.gypmartfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
