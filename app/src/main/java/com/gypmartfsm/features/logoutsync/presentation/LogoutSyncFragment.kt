package com.gypmartfsm.features.logoutsync.presentation
...
import com.gypmartfsm.CustomConstants


import com.gypmartfsm.R
import com.gypmartfsm.app.AppDatabase
import com.gypmartfsm.app.NetworkConstant
import com.gypmartfsm.app.Pref
import com.gypmartfsm.app.domain.*
import com.gypmartfsm.app.types.FragType
import com.gypmartfsm.app.utils.AppUtils
import com.gypmartfsm.app.utils.Toaster
import com.gypmartfsm.base.BaseResponse
import com.gypmartfsm.base.presentation.BaseActivity
import com.gypmartfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.gypmartfsm.features.billing.api.AddBillingRepoProvider
import com.gypmartfsm.features.billing.model.AddBillingInputParamsModel
...
import com.gypmartfsm.features.dashboard.presentation.ReasonDialog
...
import com.gypmartfsm.features.document.model.AddEditDocumentInputParams
import com.gypmartfsm.features.document.model.DocumentAttachmentModel
...
import com.gypmartfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.gypmartfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.gypmartfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.gypmartfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.gypmartfsm.features.orderhistory.model.*
...
import com.gypmartfsm.features.quotation.model.AddQuotInputModel
import com.gypmartfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.gypmartfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.gypmartfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.gypmartfsm.features.stock.api.StockRepositoryProvider
import com.gypmartfsm.features.stock.model.AddStockInputParamsModel
import com.gypmartfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.gypmartfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.gypmartfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.gypmartfsm.features.timesheet.model.AddTimeSheetInputModel
import com.gypmartfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.gypmartfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.gypmartfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.gypmartfsm.mappackage.SendBrod
import com.gypmartfsm.widgets.AppCustomTextView
import com.gypmartfsm.MonitorService
import com.gypmartfsm.MySingleton
import com.gypmartfsm.features.addshop.model.*
import com.gypmartfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.gypmartfsm.features.addshop.presentation.ShopExtraContactReq
import com.gypmartfsm.features.addshop.presentation.multiContactRequestData
import com.gypmartfsm.features.contacts.CallHisDtls
import com.gypmartfsm.features.login.api.LoginRepositoryProvider
import com.gypmartfsm.features.login.model.GetConcurrentUserResponse
import com.gypmartfsm.features.login.model.WhatsappApiData
import com.gypmartfsm.features.performance.model.Gps_status_list
import com.gypmartfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.gypmartfsm.features.returnsOrder.ReturnProductList
import com.gypmartfsm.features.returnsOrder.ReturnRequest
import com.gypmartfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xgypmartfsmlogsample/log.zip").path);
